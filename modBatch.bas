...
Public Sub RunBatchStep3()
    ...
    filePath = BatchOutputPath("batch_step3")
...
' fc list: {240, 280, 320} (mid-high practical range)
' Trials continue the random stream without restarting it.
'================================================================================
Public Sub RunBatchStep3_A3()
    ...
    filePath = BatchOutputPath("batch_step3_A3")
    Call WriteHeader(filePath)
...
'================================================================================
' Phase A3: run 30 trials with fixed fc (fresh random trials)
'================================================================================
...
Private Sub RunSingleTrial(filePath As String, phase As String, algoName As String, _
    ...
    If algoName = "BA" Then
        d = modBA.BisectionOptimization(maxIter, wallH, backfillH, _
                                        ...
                                        allowQa, conCover, mat, TrialNumber:=CLng(trial))
    Else
    ...
    isOK = modShared.CheckDesignValid(d, d.ASst_DB, d.ASst_Sp, d.AStoe_DB, d.AStoe_Sp, d.ASheel_DB, d.ASheel_Sp, FS_OT, FS_SL, FS_BC)
    IsValid = d.IsValid
...
' For each cell: report observed cost consistency across successive random trials.
...
Private Sub WriteHeader(filePath As String)
    ...
    header = "phase,run_id,algorithm,trial,H,qa,phi,fc,fy,max_iter," & _
             ...
             "runtime_sec,timestamp,evaluations,status"
