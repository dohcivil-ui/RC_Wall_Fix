...
Public Function HillClimbingOptimization(MaxIterations As Long, _
    ...
    For iteration = 1 To MaxIterations
        ...
        If is_valid Then
            If neighbor_cost < current_cost Then    ' Accept improvement
                current = neighbor
                current_cost = neighbor_cost
                If neighbor_cost < best_cost Then   ' Track new best
                    best = neighbor
