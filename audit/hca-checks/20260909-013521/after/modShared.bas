...
Public Const RESULT_CSV_ROOT As String = "C:\reserch 69\RC_Wall_Fix\audit\hca-checks\20260909-013521\after\result_csv"
...
Public Sub FinishSearch()
    ...
    If RunAlgorithm = "HCA" Then Print #f, "SearchPolicy=" & HCA_SEARCH_POLICY & "; StagnationLimit=" & HCA_STAGNATION_LIMIT & "; Refinements=" & HCARefinementCount
