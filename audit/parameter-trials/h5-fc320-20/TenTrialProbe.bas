...
Public Sub RecordTrial()
    ...
    If H <> 5 Or currentMaterial.fc <> 320 Then Err.Raise 5, , "Actual H/fc mismatch"
...
Public Sub Main()
    ...
    Form1.cboConcreteStrength.ListIndex = 4
    If Val(Form1.cboConcreteStrength.Text) <> 320 Then Err.Raise 5, , "Concrete-strength selector mismatch"
    RunMethod "BA"
    RunMethod "HCA"
