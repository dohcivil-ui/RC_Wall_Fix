...
Get-ChildItem -LiteralPath $PSScriptRoot -File | Where-Object { $_.Name -match '^project-(regression\.txt|fixtures\.csv|H[345]-(detail\.csv|report\.txt))$' } | Copy-Item -Destination $projectEvidence
