...
ผลทดลองเพิ่มเติมตามคำขอผู้ใช้: [BA 30 ครั้งด้วย VB6 จริง](TRIAL30_RESULT_TH.md) ใช้ H=5, H1=1.2, active/passive เต็มค่า, n=Es/Ec, seed 12345–12374 และงบ 5,000 evaluations ต่อครั้ง รวม 150,000; NO_SOLUTION ทั้งหมด เก็บหลักฐานแยกราย trial โดยไม่เปิดเกณฑ์ WSD จำลอง การทดลองนี้ยังไม่ใช่ผลเปรียบเทียบราคาหรือผลวิจัย BA/HCA และไม่ได้เปลี่ยนซอร์สคำนวณหลักเพิ่ม
...
> รายงานนี้เป็นประวัติการตรวจตั้งต้นก่อนเปิดเกณฑ์ production ไม่ใช่สถานะล่าสุด ดู [รายงานปิดงาน](CLOSEOUT_REVIEW_TH.md) และ [เกณฑ์ปัจจุบัน](PROJECT_CHECKS_IMPLEMENTATION_TH.md) ผล 30 trials เดิมไม่ใช่ผลของรุ่นปัจจุบัน
