...
Public Sub BAParity(state() As Integer, sampleSeed As Long, result() As Integer, ByRef nextRandom As Single)
    Dim dummy As Single
    Call InitializeCurrentDesign_BA
    ...
    Call GenerateNeighbor_BA(result(1), result(2), result(3), result(4), result(5), result(6), result(7), result(8), result(9), result(10), result(11))
    nextRandom = Rnd
End Sub
