...
Public Sub Main()
    ...
    Call Near("reference fc180 n", refParams.n, 10.069710097350)
    Call Near("reference fc180 k", refParams.k, 0.352232740008)
    Call Near("reference fc180 j", refParams.j, 0.882589086664)
    Call Near("reference fc180 R", refParams.R, 12.590509278029)
    Call Near("reference fc180 balanced rho", CalculateRhoBalanced(refParams), 0.009510283980)
    ...
    Call Near("reference fc180 actual balanced ca", ca, 81.000000000000)
    Call Near("reference fc180 actual balanced sa", sa, 1500.000000000000)
    Call Near("reference fc180 actual balanced ja", ja, 0.882589086664)
    refParams = CalculateWSDParameters(4000, 210)
    Call Near("reference fc210 n", refParams.n, 9.322740007009)
    Call Near("reference fc210 k", refParams.k, 0.341340292782)
    Call Near("reference fc210 j", refParams.j, 0.886219902406)
    Call Near("reference fc210 R", refParams.R, 14.293246005195)
    Call Near("reference fc210 balanced rho", CalculateRhoBalanced(refParams), 0.009487252255)
    ...
    Call SectionStresses(CalculateMomentCapacity(refParams.R, 0.3), 0.3, CalculateRhoBalanced(refParams) * 100# * 30#, refParams.n, ca, sa, ja)
    Call Near("reference fc210 actual balanced ca", ca, 94.500000000000)
    Call Near("reference fc210 actual balanced sa", sa, 1700.000000000000)
    Call Near("reference fc210 actual balanced ja", ja, 0.886219902406)
    refParams = CalculateWSDParameters(4000, 240)
    Call Near("reference fc240 n", refParams.n, 8.720624753050)
    Call Near("reference fc240 k", refParams.k, 0.356506048498)
    Call Near("reference fc240 j", refParams.j, 0.881164650501)
    Call Near("reference fc240 R", refParams.R, 16.963588491799)
    Call Near("reference fc240 balanced rho", CalculateRhoBalanced(refParams), 0.011324309776)
    ...
    Call SectionStresses(CalculateMomentCapacity(refParams.R, 0.3), 0.3, CalculateRhoBalanced(refParams) * 100# * 30#, refParams.n, ca, sa, ja)
    Call Near("reference fc240 actual balanced ca", ca, 108.000000000000)
    Call Near("reference fc240 actual balanced sa", sa, 1700.000000000000)
    Call Near("reference fc240 actual balanced ja", ja, 0.881164650501)
    refParams = CalculateWSDParameters(4000, 280)
    Call Near("reference fc280 n", refParams.n, 8.073729678948)
    Call Near("reference fc280 k", refParams.k, 0.374376662844)
    Call Near("reference fc280 j", refParams.j, 0.875207779052)
    Call Near("reference fc280 R", refParams.R, 20.642414159847)
    Call Near("reference fc280 balanced rho", CalculateRhoBalanced(refParams), 0.013873958682)
    ...
    Call SectionStresses(CalculateMomentCapacity(refParams.R, 0.3), 0.3, CalculateRhoBalanced(refParams) * 100# * 30#, refParams.n, ca, sa, ja)
    Call Near("reference fc280 actual balanced ca", ca, 126.000000000000)
    Call Near("reference fc280 actual balanced sa", sa, 1700.000000000000)
    Call Near("reference fc280 actual balanced ja", ja, 0.875207779052)
    refParams = CalculateWSDParameters(4000, 320)
    Call Near("reference fc320 n", refParams.n, 7.552282573013)
    Call Near("reference fc320 k", refParams.k, 0.390140806161)
    Call Near("reference fc320 j", refParams.j, 0.869953064613)
    Call Near("reference fc320 R", refParams.R, 24.437101676422)
    Call Near("reference fc320 balanced rho", CalculateRhoBalanced(refParams), 0.016523610614)
    ...
    Call SectionStresses(CalculateMomentCapacity(refParams.R, 0.3), 0.3, CalculateRhoBalanced(refParams) * 100# * 30#, refParams.n, ca, sa, ja)
    Call Near("reference fc320 actual balanced ca", ca, 144.000000000000)
    Call Near("reference fc320 actual balanced sa", sa, 1700.000000000000)
    Call Near("reference fc320 actual balanced ja", ja, 0.869953064613)
    Close #refFile
    refParams = CalculateWSDParameters(4000, 320)
