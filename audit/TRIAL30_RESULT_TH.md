...
> รายงานประวัติก่อนเปิด `PROJECT_WSD_ACI99_V1` ผลและ verifier ชุดนี้ไม่ใช้ตัดสินรุ่นปัจจุบัน วิธีทดลองปัจจุบันอยู่ใน [PROJECT_CHECKS_IMPLEMENTATION_TH.md](PROJECT_CHECKS_IMPLEMENTATION_TH.md) ผู้ใช้จะรัน 30 ครั้งเอง
