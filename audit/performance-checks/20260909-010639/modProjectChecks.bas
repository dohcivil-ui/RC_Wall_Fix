...
Public Function ProjectStemStressCheck(d As Design, r As ProjectDetail) As Boolean
    ...
    ProfileCalls(2) = ProfileCalls(2) + 1
    ProjectStemStressCheck = ProjectStemStressCheckImpl(d, r)
    ProfileSeconds(2) = ProfileSeconds(2) + ClockSeconds() - started
End Function

Public Function ProjectStemStressCheckImpl(d As Design, r As ProjectDetail) As Boolean
    ...
    ProjectStemStressCheckImpl = StemInterval(d, r, hp, hs, 0)
End Function

Private Function BaseEnvelope(d As Design, r As ProjectDetail) As Boolean
    Dim started As Double
    started = ClockSeconds()
    ProfileCalls(1) = ProfileCalls(1) + 1
    BaseEnvelope = BaseEnvelopeImpl(d, r)
    ProfileSeconds(1) = ProfileSeconds(1) + ClockSeconds() - started
End Function

Private Function BaseEnvelopeImpl(d As Design, r As ProjectDetail) As Boolean
    ...
    For mask = 0 To 15
        ...
        Next i
    Next mask
    BaseEnvelopeImpl = True
End Function

Public Function CheckProjectDesign(d As Design, r As ProjectDetail) As Boolean
    Dim started As Double
    started = ClockSeconds()
    ProfileCalls(0) = ProfileCalls(0) + 1
    CheckProjectDesign = CheckProjectDesignImpl(d, r)
    ProfileSeconds(0) = ProfileSeconds(0) + ClockSeconds() - started
End Function

Public Function CheckProjectDesignImpl(d As Design, r As ProjectDetail) As Boolean
...
Public Function ProjectQuantityCost(d As Design, r As ProjectDetail) As Boolean
    Dim started As Double
    started = ClockSeconds()
    ProfileCalls(3) = ProfileCalls(3) + 1
    ProjectQuantityCost = ProjectQuantityCostImpl(d, r)
    ProfileSeconds(3) = ProfileSeconds(3) + ClockSeconds() - started
End Function

Public Function ProjectQuantityCostImpl(d As Design, r As ProjectDetail) As Boolean
    ...
    ProjectQuantityCostImpl = True
    Exit Function
BadQuantity:
    ProjectQuantityCostImpl = False
End Function
