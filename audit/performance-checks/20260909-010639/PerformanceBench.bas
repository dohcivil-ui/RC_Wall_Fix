...
Public Sub Main()
    ...
    For method = 0 To 1
        ...
        If method = 0 Then
            d = BisectionOptimization(1024, 5, 1.2, 1.8, 2.4, 30, 0.6, 30, 0.075, mat, RandomSeed:=12345, TrialNumber:=1)
        Else
            d = HillClimbingOptimization(1024, 5, 1.2, 1.8, 2.4, 30, 0.6, 30, 0.075, mat, RandomSeed:=12345, TrialNumber:=1)
        End If
