...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'full-sizing-vb6.md'), (Join-Path $PSScriptRoot 'full-sizing-summary.csv'), (Join-Path $PSScriptRoot 'full-sizing-bar-options.csv'), (Join-Path $PSScriptRoot 'full-sizing-improvements.csv') -Destination $evidence
...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'full-sizing-independent-checks.txt'), (Join-Path $PSScriptRoot 'full-sizing-boundary-cases.csv'), (Join-Path $PSScriptRoot 'full-sizing-flags-0.bin.gz'), (Join-Path $PSScriptRoot 'full-sizing-flags-1.bin.gz') -Destination $evidence
