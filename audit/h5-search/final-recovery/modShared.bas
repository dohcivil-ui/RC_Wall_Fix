...
Public Const NEIGHBOR_SEARCH_POLICY As String = "MEMBER_RANDOM_V1"
Public Const RESULT_CSV_ROOT As String = "C:\reserch 69\RC_Wall_Fix\audit\h5-search\final-recovery\result_csv"
