...
Public Const NEIGHBOR_SEARCH_POLICY As String = "MEMBER_WEIGHTED_EXPERIMENT_V1"
Public Const RESULT_CSV_ROOT As String = "C:\reserch 69\RC_Wall_Fix\audit\h5-search\weighted\result_csv"
